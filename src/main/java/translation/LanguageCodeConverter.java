...
public class LanguageCodeConverter {
    ...
    public LanguageCodeConverter(String filename) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                languageCodeToLanguage.put(tokens[right], tokens[0]);
                for (int i = 0; i < right; i++) {
                    languageToLanguageCode.put(tokens[i], tokens[right]);
                }
            }
    ...
    public Set<String> getAllLanguageNames() { return languageToLanguageCode.keySet(); }
}
